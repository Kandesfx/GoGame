#!/bin/bash
# Script để parse data 9x9 từ raw_sgf_9x9
# Tự động chia thành các chunks với kích thước hợp lý
...
# Sử dụng Python từ Windows (không phải MSYS2)
# Lưu ý: Trong Git Bash, không dùng backslash continuation
